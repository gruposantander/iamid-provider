...
cookies::
The cookies configurtaion for the server, as described in https://github.com/panva/node-oidc-provider/blob/master/docs/README.md#cookies[oidc-provider configuration cookies]
