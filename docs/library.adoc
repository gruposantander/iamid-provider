...
[source,js]
----
const { IAmId } = require('iamid-provider') <1>
...
[source,js]
----
const { IAmIdRouter } = require('iamid-provider') <1>
...
[source,js]
----
const { resolvers : { proxyClaimResolvers } } = require('iamid-provider')
...
[source,js]
----
const { utils: { normalizePhoneNumber } } = require('iamid-provider')
...
[source,js]
----
const { utils: { Sensitive } } = require('iamid-provider') <1>
const anObject = {
    user: 'hello',
