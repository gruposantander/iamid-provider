...
IAMID is provided as a library for implement an OP (Openid Provider), so for example using `npm` you can install in your project using:

[source,bash]
----
npm install --save aimid-provider
----
