...
class Consent {
  ...
  static createConsent (clientId, userId, claims, scopes) {
    return new Consent(nanoid(), clientId, userId, claims, scopes)
  }

  static fromJSON (obj) {
    if (!obj) return null
    const { id, clientId, userId, claims, scopes, accepted } = obj
    return new Consent(id, clientId, userId, Claims.fromJSON(claims), scopes, accepted && Accepted.fromJSON(accepted))
  }

  constructor (id, clientId, userId, claims, scopes, accepted = null) {
    this.id = id
  ...
  resolve (accepted) {
    ...
    return new Consent(this.id, this.clientId, this.userId, claims, scopes, accepted)
  }
