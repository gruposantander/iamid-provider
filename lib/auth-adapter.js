...
const AUTH_REPO_NAME = 'UserAuthorizations'

// TODO should avoid insert same system with diferent userid??
// TODO memory filter is not working because don't understand the keys...
...
class AuthAdapter {
  ...
  async save (systemId = '', systemUid = '', authData = {}) {
    ...
    authorization.addSystemAuth(new SystemAuth(systemId, systemUid, authData))
...
module.exports = { AuthAdapter, Authorization, SystemAuth }
